...
import io.cloink.gomobile.android.ProfileManager;
import io.cloink.gomobile.android.ProfileArray;
...
public class ProfileManagerWrapper {
    ...
    public ProfileManagerWrapper(Context context) {
        ...
        this.profileManager = io.cloink.gomobile.android.Android.newProfileManager(configDir);
    }
        ...
        try {
            ...
            if (array != null) {
                for (int i = 0; i < array.length(); i++) {
                    io.cloink.gomobile.android.Profile p = array.get(i);
                    if (p != null) {
    ...
    public Profile getActiveProfile() {
        try {
            io.cloink.gomobile.android.Profile p = profileManager.getActiveProfile();
            if (p == null)  {
