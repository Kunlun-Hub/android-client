...
import io.cloink.client.tool.networks.ConcreteNetworkAvailabilityListener;
import io.cloink.client.tool.networks.NetworkChangeDetector;
...
public class VPNService extends android.net.VpnService {
    ...
    public static final String INTENT_ACTION_START = "io.cloink.client.intent.action.START_SERVICE";
    public static final String ACTION_STOP_ENGINE = "io.cloink.client.intent.action.STOP_ENGINE";
