 ...
 *       grant {@code adb shell pm grant io.cloink.client android.permission.WRITE_SECURE_SETTINGS}</li>
 ...
 *   -Pandroid.testInstrumentationRunnerArguments.class=io.cloink.client.NetworkConnectivityStressTest
 * </pre>
 */
