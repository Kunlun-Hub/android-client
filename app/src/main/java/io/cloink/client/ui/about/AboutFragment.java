...
import io.cloink.client.databinding.FragmentAboutBinding;
...
public class AboutFragment extends Fragment {
    ...
    public void onLicenseClick(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Kunlun-Hub/android-client/blob/main/LICENSE"));
